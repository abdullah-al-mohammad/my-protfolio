	...
	return (
		<>
			<div className="Underline">
				<h1 className="text-center capitalize text-green-600 text-2xl mb-3">
					education
				</h1>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-5">
					<div className="card card-border w-auto">
						<div className="card-body">
							...
							<p>
								I completed my Alim exam in 2016, where I studied Islamic
								subjects along with general education.
							</p>
						</div>
					</div>
