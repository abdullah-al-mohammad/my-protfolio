        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center gap-5">
          <div className="card card-border bg-base-100 w-auto shadow-2xl border border-amber-400">
            <div className="card-body">
              <div className="flex items-center">
                ...
                <h2 className="card-title capitalize font-bold">Alim HSC 2016</h2>
              </div>
              <p className="capitalize italic">manikganj islamia kamil madrasah</p>
              <p>
                I completed my Alim exam in 2016, where I studied Islamic subjects along with
                general education.
              </p>
            </div>
          </div>
          <div className="card card-border bg-base-100 w-auto shadow-2xl border border-amber-400">
            <div className="card-body">
              ...
              <p>
                I earned my Honours degree in Islamic Studies, learning about religion, history, and
                fikah.
              </p>
            </div>
          </div>
